...
var UI = (function () {
  ...
  function buildFilterBar(poles) {
    var bar = document.getElementById('filter-bar');
    var parques = MapController.getParques();

    // Botao Todos
    var btnAll = document.createElement('button');
    btnAll.className = 'filter-btn active';
    btnAll.textContent = 'Todos';
    btnAll.setAttribute('data-parque', '');
    btnAll.addEventListener('click', function () {
      setActiveFilter(this);
      MapController.filterByParque(null);
      MapController.fitToMarkers(null);
    });
    ...
    parques.forEach(function (parque) {
      ...
      btn.textContent = parque;
      btn.setAttribute('data-parque', parque);
      btn.addEventListener('click', function () {
        setActiveFilter(this);
        MapController.filterByParque(parque);
        MapController.fitToMarkers(parque);
      });
      bar.appendChild(btn);
    });
  }
