...
var MapController = (function () {
  ...
  function startGPS() {
    ...
    // Watch SEM alta precisao (usa Wi-Fi/rede, muito mais rapido no iOS)
  ...
  function centerOnGPS() {
    ...
    // Tentar sem alta precisao primeiro
    navigator.geolocation.getCurrentPosition(
      ...
      function () {
        // Se falhou sem precisao, tentar COM alta precisao
        navigator.geolocation.getCurrentPosition(
          function (pos) {
            var latlng = L.latLng(pos.coords.latitude, pos.coords.longitude);
            lastGPSLatLng = latlng;
          ...
          function (err) {
            btn.style.background = '';
            btn.style.opacity = '';
            alert('Erro GPS (codigo ' + err.code + '): ' + err.message + '\n\nVerifique:\n1. Ajustes > Privacidade > Servicos de Localizacao > LIGADO\n2. Role ate Chrome > Enquanto Usa');
          },
